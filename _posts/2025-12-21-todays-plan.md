...
<!-- last-update: 2025-12-21T20:11:55.915982+00:00 -->
<!-- unit-ids: add-metadata-validation,add-tracker-metadata-fields,convert-mcp-toon-cancelled-items,create-planning-workflow-status-taxonomy,create-sync-checklist-script,regenerate-all-checklists,update-agents-md-reference,update-build-work-units,update-work-status-enum,validate-dev-tracker-build -->